...
export const Index = () => {
    ...
    const modalAddRevenue = () => {
        return (
            <Modal
                title={<Title level={4} strong>{isEdit ? 'Edit Revenue' : 'Add Revenue'}</Title>}
                visible={isModal}
                maskClosable={false}
                closable={false}
                footer={
            ...
            >
                <Form form={form} layout={'vertical'}>
                    ...
                    <Row gutter={24}>
                        ...
                        <Col>
                            <Form.Item name={'bank_account_no'} label={'Bank Account Number'} rules={[
                                {
                                    required: true,
                    ...
                    <Form.Item name={'bank_account_holder_name'} label={'Bank Account Holder Name'} rules={[
                        {
                            required: true,
                    ...
                    <Form.Item name={'status'} label={'Status Transfer'} rules={[
                        {
                            required: true,
                        ...
                        <Select placeholder={'Select status transfer'}>
                            <Select.Option key="transferred" value={'transferred'}>Transferred</Select.Option>
                            <Select.Option key="not_available" value={'not_available'}>Not Available</Select.Option>
                        </Select>
                    </Form.Item>
                </Form>
            </Modal>
    ...
    return <Card
        title={<Title level={4} strong>Admin SC Group Music</Title>}
        extra={<Button type={'primary'} icon={<PlusOutlined/>} onClick={() => setIsModal(true)}>Add Revenue</Button>}
    >
        {modalAddRevenue()}
        <Table
            columns={columns}
